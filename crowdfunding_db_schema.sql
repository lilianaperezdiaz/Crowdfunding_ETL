...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/l49rcP
...
CREATE TABLE "Estate_Type" (
    "estate_type_id" VARCHAR(255)   NOT NULL,
    "estate_type" VARCHAR(255)   NOT NULL,
...
ALTER TABLE "Agent_Region_Junction" ADD CONSTRAINT "fk_Agent_Region_Junction_agent_id" FOREIGN KEY("agent_id")
REFERENCES "Agents" ("agent_id");

ALTER TABLE "Agent_Region_Junction" ADD CONSTRAINT "fk_Agent_Region_Junction_region_id" FOREIGN KEY("region_id")
